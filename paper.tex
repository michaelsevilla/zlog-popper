...
Figure~\ref{fig:vanilla_wr_firefly} shows that the performance overhead with
an older version of Ceph makes the decisions much less clear where a
relatively smaller overhead is present when using the key-value interface
rather than the bytestream.
