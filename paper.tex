...
primary source of motivation for selection of a declarative langauge. While
...
made available to the OSD and used to reorder and collesce requests based on
