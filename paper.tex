...
by a marked increase in production Ceph extensions. The construction of
extensions is not limited to core developers; the community has been receptive
to contributions with the recent inclusion by CERN developers of an extension
for performing limited numeric operations on object data~\cite{cls_numops}.
